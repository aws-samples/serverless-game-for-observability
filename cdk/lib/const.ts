...
export class Constants {
    ...
    public static readonly enableLambdaInsights = process.env.ENABLE_LAMBDA_INSIGHTS || "false";
    public static readonly enableApplicationSignals = process.env.ENABLE_APP_SIGNALS || "false";
